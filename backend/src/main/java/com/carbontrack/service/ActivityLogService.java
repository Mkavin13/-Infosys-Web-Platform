...
public class ActivityLogService {
    ...
    public ActivityLogDto createLog(ActivityLogRequest request, User user) {
        ...
        // Custom gamification triggers
        if (request.getCategory() == ActivityCategory.TRANSPORT && 
            ("PUBLIC_TRANSIT".equalsIgnoreCase(request.getActivityType()) || "CAR_ELECTRIC".equalsIgnoreCase(request.getActivityType()))) {
            badgeService.awardBadgeDirectly(user, "Green Commuter");
        }
